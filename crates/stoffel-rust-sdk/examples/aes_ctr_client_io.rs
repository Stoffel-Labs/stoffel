//! End-to-end client-I/O demo for AES-128 CTR over MPC, driven by the Rust SDK.
//!
...
const PROGRAM: &str = concat!(
    ...
    "/../stoffel-lang/examples/mpc_aes128_ctr_client_io/main.stfl"
);
const PLAINTEXT_HEX: &str = "6bc1bee22e409f96e93d7e117393172a";
const KEY_HEX: &str = "2b7e151628aed2a6abf7158809cf4f3c";
const EXPECTED_C0: &str = "874d6191b620e3261bef6864990db6ce";
...
async fn main() -> stoffel::Result<()> {
    ...
    println!("Running AES-128 CTR over MPC (client 0 = plaintext, client 1 = key)...");
    ...
    assert_eq!(
        hex, EXPECTED_C0,
        "client-received AES-128 CTR ciphertext must match the NIST SP 800-38A vector"
    );
