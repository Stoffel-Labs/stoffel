...
```sh
stoffel run crates/stoffel-lang/examples/mpc_pattern_match --client-input 0=1 --client-input 0=2 --client-input 0=3 --client-input 0=2 --client-input 0=3 --client-input 1=2 --client-input 1=3 --expected-output-clients 2
```
