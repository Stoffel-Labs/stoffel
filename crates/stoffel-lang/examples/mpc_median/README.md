...
```sh
stoffel run crates/stoffel-lang/examples/mpc_median --client-input 0=50 --client-input 1=20 --client-input 2=40 --client-input 3=10 --client-input 4=30 --expected-output-clients 5
```
